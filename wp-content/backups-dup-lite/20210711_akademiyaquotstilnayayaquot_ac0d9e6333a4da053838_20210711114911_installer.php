...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210711_akademiyaquotstilnayayaquot_ac0d9e6333a4da053838_20210711114911_archive.zip';
	const ARCHIVE_SIZE		 = '78834868';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ac0d9e6-11114911';
    const SECONDARY_PACKAGE_HASH = '63927bb-11114911';
	const VERSION			 = '1.4.2';
