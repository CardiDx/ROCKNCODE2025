            ...
            <div class="col-12 col-md-12">
                <div class="breadcrumbs">
                    <ul class="breadcrumbs__list">
                        ...
                        <li class="breadcrumbs__item"><span class="breadcrumbs__item-link breadcrumbs_active"><?= get_the_category_by_ID( 7 ); ?></span></li>
                    </ul>
                </div>
                <h2 class="main__title">Категория: <span class="highlighted"><?= get_the_category_by_ID( 7 ); ?></span></h2>
            </div>
        </div>
    </div>
                        ...
                        <div class="main-blog-item">
                            ...
                            <div class="main-blog-item-content">
                                ...
                                <p class="main-blog-item__text"><?php echo implode(' ', array_slice(explode(' ', wp_strip_all_tags(get_the_content())), 0, 20)); ?>
                                    <a href="<?= get_the_permalink(); ?>" class="main-blog-item__text-more">Читать&nbsp;дальше<img
                                                src="/wp-content/themes/style/img/icons/long-arrow.svg"
                                                class="main-blog-item__text-more-img" alt=""></a></p>
