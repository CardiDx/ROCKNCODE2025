            ...
            <div class="col-12 col-md-12">
                <div class="breadcrumbs">
                    <ul class="breadcrumbs__list">
                        ...
                        <li class="breadcrumbs__item"><span class="breadcrumbs__item-link breadcrumbs_active"><?= get_the_category_by_ID( 9 ); ?></span></li>
                    </ul>
                </div>
                <h2 class="main__title">Категория: <span class="highlighted"><?= get_the_category_by_ID( 9 ); ?></span></h2>
            </div>
        </div>
    </div>
